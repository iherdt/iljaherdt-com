      ...
      <section className="max-w-xl mx-auto px-6 pt-16 pb-16">
        ...
        <div className="mt-10 pt-8 border-t border-gray-100">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a href="https://linkedin.com/in/iljaherdt" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-sm text-gray-600 hover:text-gray-900 transition">
